...
class Step_1(Scene):
    def construct(self):
        ...
        label_C = MathTex("C",color=BLACK).next_to(P, UP*0.7)
        ...
        label_mn = MathTex("m : n", color="#E53935").next_to(P, UP*3.5)
        #curve
        ...
        tip5 = StealthTip(color="#E53935", length=0.25).rotate(angle2).move_to(curve2_end)

        self.add(OP, AB, OA, OB,tip1, tip2, tip3,label_A, label_B, label_C, label_O,label_a, label_b,
            label_mn,curve1, curve_tip,curve2,tip4,tip5)