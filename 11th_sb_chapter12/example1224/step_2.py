...
class Step_1(Scene):
    def construct(self):
        ...
        rect.set_fill("#EAEAAD", opacity=1)
        rect.set_stroke(BLACK, width=4)
        ...
        ellipse = Ellipse(width=5.8, height=4.7).rotate(25 * DEGREES).set_stroke(RED, width=5)
        top_mask = VMobject()
        ...
        ellipse_outline = ellipse.copy().set_fill(opacity=0).set_stroke(5).set_color(RED)
        
        arrow = CurvedArrow(
            start_point=ellipse.get_bottom(),
